        ...
        results.append(
            {
                ...
                "target_distance": final["target_distance"],
                "target_progress": final["target_progress"],
                ...
                "party_species_progress": final["party_species_progress"],
                ...
                "item_progress": final["item_progress"],
                "key_item_progress": final["key_item_progress"],
                "ball_progress": final["ball_progress"],
                "badges": final["badge"],
                "badge_progress": final["badge_progress"],
...
def success_rates(results):
    ...
    return {
        ...
        "target_reached": rate(
            lambda episode: episode.get("target_distance", -1) == 0
        ),
        "pokedex_seen": rate(
